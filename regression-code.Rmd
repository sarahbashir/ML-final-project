...
#RMSE(prediction, testData$MaxTemp/mean(testData$MaxTemp))

train.control <- trainControl(method = "cv", number = 10)
#train the model
model <- train(MaxTemp ~ MinTemp, data = war_Data, method = "lm", trControl = train.control)
print(model)
